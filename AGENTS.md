...
- **Shared skills:** [skills/](skills/README.md) is the fleet catalog and empty central home. Implementations live in owner repos; a skill that later lands here is an ENG-0006 primitive owned in `.github/CODEOWNERS` and subject to the same gates as docs, and must be linked from that index.
