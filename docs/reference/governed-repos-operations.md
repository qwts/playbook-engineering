...
byte-for-byte. This keeps consumer formatters from rewriting managed files
while language and syntax validation remains at the governance source. Missing
markers append the block once; duplicated, partial, or reversed markers fail
closed.
