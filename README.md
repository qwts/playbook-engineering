...
- [Machine memory guard](docs/reference/agent-memory-guard.md) — a machine-scoped memory budget for agent sessions; its decision (ENG-0138) is still Proposed, so the implementation lives in this repository and is not deployed to the fleet.
